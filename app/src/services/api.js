...
export const favoritesAPI = {
  ...
  removeFromFavorites: (id) => api.delete(`/favorites/${id}`),
...
export const flagsAPI = {
  ...
  updateFlag: (id, flagData) => api.put(`/flags/${id}/review`, flagData),
...
export const usersAPI = {
  ...
  getMerchantDashboard: () => api.get('/users/merchant/dashboard'),

  changeRole: (userId, newRole) => api.put('/users/role', { userId, newRole }),
